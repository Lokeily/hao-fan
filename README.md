...
<p align="center">
  ...
  <a href="https://github.com/Lokeily/hao-fan/releases/latest"><img src="https://img.shields.io/badge/version-0.1.6-blue" alt="v0.1.6"></a>
</p>
...
| 节省 Token | 句子级缓存、重复文本合并、术语库命中零请求、目标语言跳过 |
